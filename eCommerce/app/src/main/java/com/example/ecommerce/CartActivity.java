    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NextProcessBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                textTotalAmount.setText("Tổng tiền: " + String.valueOf(overTotalPrice) + "đ");

                Intent intent = new Intent(CartActivity.this,  ConfirmFinalOrderActivity.class);
                intent.putExtra("Tổng tiền", overTotalPrice + "đ");
    ...
    protected void onStart() {
        ...
        try {
            if (Prevalent.currentOnlineUser == null) {
                Toast.makeText(CartActivity.this, "Xin vui lòng đăng nhập để mua hàng!", Toast.LENGTH_SHORT).show();
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter
            ...
            protected void onBindViewHolder(@NonNull CartViewHolder cartViewHolder, int i, @NonNull Cart cart) {
                cartViewHolder.txtProductQuantity.setText(" Số lượngx" + cart.getQuantity());
                cartViewHolder.txtProductName.setText( "Tên sản phẩm:" + cart.getPname());
